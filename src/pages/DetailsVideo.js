...
const DetailsVideo = () => {
  ...
  const fetchcomments = async () => {
    ...
    try {
      const response = await axios.get(
        `${url}/site_management/video/get_comments/${id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  //update the data
    ...
    const handleUpdate = async () => {
      ...
      form.append("video_id", id);

        try {
          const response = await axios.put(
            `${url}/website/update/video`,
            form, 
            {
    ...
    useEffect(() => {
      const fetchVideo = async () => {
        ...
        try {
          const response = await axios.get(
            `${url}/site_management/video/details/${id}`,
            {
              headers: { Authorization: `Bearer ${token}` },
            }
          );
      ...
      <div>
        ...
        <div className="flex">
          ...
          <div className="p-5 w-full max-h-[90vh] overflow-scroll">
            <BreadCrumb page={["Site management", "Video Details"]} />
            <div className="mt-5">
              <div className="container flex justify-between items-center">
                <h2 className="bold">Video Details</h2>
                <div>
                  <button
                ...
                <div className="container mt-5 grid grid-cols-3">
                  <div className="container  col-span-2 ">
                    ...
                    {isloadingComments ? (
                      ...
                      <ShowComments comments={comments} url={url}  commentType="videos" />
                    )}
                  </div>
