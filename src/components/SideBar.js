...
const Sidebar = () => {
  ...
  const [isOpenLeaves, setIsOpenLeaves] = useState(false);
  ...
  const handleToggleLeaves = () => {
    setIsOpenLeaves(!isOpenLeaves);
  };
  const handleToggleSide = () => {
    setIsOpenSide(!isOpenLeaves);
  };
          ...
          <div className="flex-1">
            <ul className="menu pt-2 pb-4 space-y-1 text-sm">
              ...
              <li className="rounded-sm">
                ...
                <ul
                  className={` space-y-2 transition-max-height duration-300 ease-in-out ${
                    isOpenLeaves ? "max-h-screen" : "max-h-0 overflow-hidden"
                  }`}
                >
                  <li>
                    <Link
                      to="/system/leave_management/leave_types"
