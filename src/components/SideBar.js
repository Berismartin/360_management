...
const Sidebar = () => {
  ...
  const handleToggle = () => {
    ...
    return ( 
        <div className='sidebar h-full'>
            <div className="flex flex-col h-full p-3 w-60 bg-base-300 border-e-2 border-gray-500
			 dark:text-gray-800">
      ...
      <button
        type="button"
        className="flex items-center w-full p-2 text-base   transition duration-75 rounded-lg group   dark:text-white dark:hover:bg-gray-700"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5c-3.162 0-6.133-.815-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418" />
      ...
      <ul
        className={` space-y-2 transition-max-height duration-300 ease-in-out ${isOpen ? 'max-h-screen' : 'max-h-0 overflow-hidden'}`}
      >
        <li>
          <Link
            to="/manage/videos"
          ...
          >
            Manage Users
							...
							<li className="rounded-sm dark:bg-gray-100 dark:text-gray-900">
								<Link to='/users' rel="noopener noreferrer"  className="flex items-center p-2 space-x-3 rounded-md">
				...
				<div className="flex items-center p-2 mt-12 space-x-4 justify-self-end">
					<img src="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp" alt="" className="w-12 h-12 rounded-lg dark:bg-gray-500" />
					<div>
